...
import com.onesoftware.identitykit.oauth2.TokenRefresher
import com.onesoftware.identitykit.oauth2.flows.AuthorizationFlow
import com.onesoftware.identitykit.storage.REFRESH_TOKEN
import com.onesoftware.identitykit.storage.TokenStorage
...
class IdentityKit(
    ...
    private suspend fun refresherRefreshToken(refreshToken: String): Token? {
        ...
        return try {
            ...
            if (kitConfiguration.authenticateOnFailedRefresh && e is OAuth2InvalidGrantError) {
